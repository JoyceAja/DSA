 ...
 * by one in N days. In each day, there will be exactly one flower blooming and it will be in 
 * the status of blooming since then.
 ...
 * status of blooming, and also the number of flowers between them is k and these flowers are 
 * not blooming.
